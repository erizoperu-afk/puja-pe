  ...
  return (
    <main style={{ fontFamily:'sans-serif', background:'#f9f9f9', minHeight:'100vh' }}>
      ...
      <div style={{ maxWidth:'800px', margin:'0 auto', padding:'48px 24px' }}>
        <h1 style={{ fontSize:'28px', fontWeight:'500', marginBottom:'8px' }}>Política de Privacidad</h1>
        ...
        {[
          ...
          ['3. Compartir información', 'No vendemos ni compartimos tu información personal con terceros, excepto cuando sea necesario para operar el servicio (por ejemplo, procesar pagos) o cuando la ley lo requiera.'],
