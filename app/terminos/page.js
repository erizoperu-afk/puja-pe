  ...
  return (
    <main style={{ fontFamily:'sans-serif', background:'#f9f9f9', minHeight:'100vh' }}>
      ...
      <div style={{ maxWidth:'800px', margin:'0 auto', padding:'24px 16px' }}>
        <h1 style={{ fontSize:'24px', fontWeight:'500', marginBottom:'8px' }}>Términos y Condiciones</h1>
        ...
        {[
          ...
          ['8. Responsabilidad', 'Puja.pe actúa como intermediario y no es responsable de las transacciones entre compradores y vendedores.'],
