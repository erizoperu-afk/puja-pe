            ...
            <>
              ...
              <div style={{ marginBottom:'14px' }}>
                ...
                <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'8px' }}>
                  <button onClick={() => setRol('comprador')}
                    style={{ padding:'12px 8px', borderRadius:'8px', border: rol === 'comprador' ? '2px solid #1D9E75' : '1px solid #ddd', background: rol === 'comprador' ? '#E1F5EE' : '#fff', cursor:'pointer', fontSize:'13px', fontWeight:'500', color: rol === 'comprador' ? '#085041' : '#666' }}>
                    Quiero comprar
                  </button>
                  <button onClick={() => setRol('vendedor')}
                    style={{ padding:'12px 8px', borderRadius:'8px', border: rol === 'vendedor' ? '2px solid #1D9E75' : '1px solid #ddd', background: rol === 'vendedor' ? '#E1F5EE' : '#fff', cursor:'pointer', fontSize:'13px', fontWeight:'500', color: rol === 'vendedor' ? '#085041' : '#666' }}>
                    Quiero vender
                  </button>
                </div>
              </div>
